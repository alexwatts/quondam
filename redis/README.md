...
kubectl create -f /Users/alex/redis-kubenetes/examples/staging/storage/redis/redis-master.yaml

# Create a service to track the sentinels
kubectl create -f /Users/alex/redis-kubenetes/examples/staging/storage/redis/redis-sentinel-service.yaml

# Create a replication controller for redis servers
kubectl create -f /Users/alex/redis-kubenetes/examples/staging/storage/redis/redis-controller.yaml

# Create a replication controller for redis sentinels
kubectl create -f /Users/alex/redis-kubenetes/examples/staging/storage/redis/redis-sentinel-controller.yaml
